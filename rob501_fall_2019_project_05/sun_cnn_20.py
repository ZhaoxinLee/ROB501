...
class CNN(torch.nn.Module):
    def __init__(self, num_bins):
        ...
        self.conv1 = torch.nn.Conv2d(3, 16, stride=3, padding=3, kernel_size=(9,9)) # 3 input channels, 16 output channels
        self.pool1 = torch.nn.MaxPool2d((3,3),stride=3)
        self.relu = torch.nn.ReLU()
        self.batchnorm1 = torch.nn.BatchNorm2d(16)
        self.conv2 = torch.nn.Conv2d(16, 16, stride=2, padding=2, kernel_size=(5,5))
        self.pool2 = torch.nn.MaxPool2d((3,3),stride=1)
        self.relu = torch.nn.ReLU()
        self.batchnorm2 = torch.nn.BatchNorm2d(16)
        self.conv3 = torch.nn.Conv2d(16,num_bins, kernel_size=(2,10))
